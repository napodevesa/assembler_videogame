 ...
 * fila 18, columna 26 llamando a la subrutina showNumberP1_C.
...
/**
 * Leer una tecla llamando a la función getchP1_C que quedará guardada
 ...
 * para poder hacer los desplazamientos de los números hacia la dreta
 * (shiftNumbersRP1_C), hacer las parejas hacia la dreta (addPairsRP1_C) 
 * y volver a desplazar los números hacia la izquierda (shiftNumbersRP1_C) 
 ...
 *   Leer una tecla (llamar a la función readKeyP1_C). Según la tecla 
...
void playP1_C(){
   ...
   state = '1';               //Estado para comenzar a jugar
   ...
   while (state == '1') {     //Bucle principal.
      readKeyP1_C();
      if (state == '2') {     //Si se ha hecho algún movimiento
         insertTileP1_C();    //Añadir ficha (2)
         state = '1';
      }
      updateBoardP1_C();
   }
   printMessageP1_C();        //Muestra el mensaje para indicar como acaba.
     ...
     printMenuP1_C();    //Mostrar menú y pedir opción
      ...
      switch(charac){
         ...
         case '4': //Rotar matriz a la derecha
            ...
            getchP1_C();
         break;
         case '5': //Desplazar números a la izquierda
            clearScreen_C();  //Borrar la pantalla
            printBoardP1_C(); //Mostrar el tablero
            //===================================================
            shiftNumbersRP1();
            //shiftNumbersRP1_C(); 
            //===================================================
            updateBoardP1_C();//Actualitzar el contenido del tablero 
            rowScreen = 18;
            colScreen = 30;
            gotoxyP1_C();
            printf(" Press any key ");
          ...
          case '6': //Sumar parejas
            ...
            printBoardP1_C(); //Mostrar el tablero
            //===================================================
            addPairsRP1();   //Sumar parejas y calcular puntos
            //addPairsRP1_C();
            //===================================================
            updateBoardP1_C();//Actualizar el contenido del tablero
            rowScreen = 18;
